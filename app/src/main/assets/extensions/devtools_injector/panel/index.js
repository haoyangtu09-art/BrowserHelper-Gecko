...
var NET_STYLE = [
  ...
  '.bh-snip{font-size:11px;color:#374151;font-family:monospace;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}',
  '.bh-snip-tag{display:inline-block;margin-right:4px;padding:0 4px;border-radius:2px;background:#e5e7eb;color:#6b7280;font-family:-apple-system,sans-serif;}',
  // 状态颜色
