...
var EXT_STYLE = [
  ...
  '  grid-template-columns:repeat(auto-fill,minmax(70px,1fr));gap:8px;align-content:start;}',
  // Compact square cards sized so four to five fit across a typical extension panel.
  '.bh-ext-card{display:flex;flex-direction:column;gap:3px;padding:6px;',
  '  border:1px solid #d0d7de;border-radius:9px;background:#fff;aspect-ratio:1/1;min-width:0;}',
  '.bh-ext-card-info{flex:1;min-width:0;overflow:hidden;display:flex;flex-direction:column;',
  '  justify-content:center;text-align:center;}',
  '.bh-ext-card-name{font-size:14px;line-height:1.1;font-weight:800;color:#111;',
  '  display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;}',
  '.bh-ext-card-ver{margin-top:3px;font-size:11px;line-height:1;font-weight:700;color:#2563eb;}',
  '.bh-ext-actions{display:flex;gap:4px;}',
  '.bh-ext-btn{flex:1;padding:3px 0;border:none;border-radius:6px;',
  '  font-size:11px;line-height:1.1;font-weight:800;text-align:center;white-space:nowrap;}',
