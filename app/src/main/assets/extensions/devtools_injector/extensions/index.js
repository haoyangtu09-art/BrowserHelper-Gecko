...
var EXT_STYLE = [
  ...
  '  grid-template-columns:repeat(auto-fill,minmax(52px,1fr));gap:6px;align-content:start;}',
  // Compact square cards sized so five to six fit across a typical extension panel.
  '.bh-ext-card{display:flex;flex-direction:column;gap:3px;padding:4px;',
  '  border:1px solid #d0d7de;border-radius:7px;background:#fff;aspect-ratio:1/1;min-width:0;}',
  '.bh-ext-card-info{flex:1;min-width:0;overflow:hidden;display:flex;flex-direction:column;',
  '  justify-content:center;text-align:center;}',
  '.bh-ext-card-name{font-size:11px;line-height:1.1;font-weight:800;color:#111;',
  '  display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;}',
  '.bh-ext-card-ver{margin-top:3px;font-size:9px;line-height:1;font-weight:700;color:#2563eb;}',
  '.bh-ext-actions{display:flex;gap:3px;}',
  '.bh-ext-btn{flex:1;padding:3px 0;border:none;border-radius:6px;',
  '  font-size:9px;line-height:1.1;font-weight:800;text-align:center;white-space:nowrap;}',
